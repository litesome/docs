...
const Utilities = () => {
  return (
    <DocLayout>
      <h1>Get started</h1>
      <div className="lead">
        Litesome CSS Framework is collection of CSS styles to consistently make
        simple and clean websites. It makes browsers render all elements faster
        and beautifies semantic HTML markups
      </div>
