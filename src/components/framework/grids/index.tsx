...
const MDGridInitial = `<div class="row">
  <div class="l-sm-12 l-md-4 l-lg-12"><div class="box">Column</div></div>
  <div class="l-sm-12 l-md-4 l-lg-12"><div class="box">Column</div></div>
  <div class="l-sm-12 l-md-4 l-lg-12"><div class="box">Column</div></div>
</div>`;
  ...
  return (
    <>
      <DocLayout>
        ...
        <div className="code-example">
          <div className="row">
            <div className="l-sm-12 l-md-6 l-lg-12">
              <div className="box primary">Column</div>
            </div>
            <div className="l-sm-12 l-md-6 l-lg-8">
              <div className="box primary">Column</div>
            </div>
            <div className="l-sm-12 l-md-6 l-lg-4">
              <div className="box primary">Column</div>
            </div>
            <div className="l-sm-12 l-md-6 l-lg-3">
              <div className="box primary">Column</div>
            ...
            <div className="l-sm-12 l-md-6 l-lg-7">
              <div className="box primary">Column</div>
            </div>
            <div className="l-sm-12 l-md-6 l-lg-2">
              <div className="box primary">Column</div>
            </div>
            <div className="l-sm-12 l-md-6 l-lg-2">
              <div className="box primary">Column</div>
